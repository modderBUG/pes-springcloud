package me.xiaowei.modules.security.config;

import me.xiaowei.annotation.AnonymousAccess;
import me.xiaowei.config.ElPermissionConfig;
import me.xiaowei.modules.security.security.JwtAuthenticationEntryPoint;
import me.xiaowei.modules.security.security.JwtAuthorizationTokenFilter;
import me.xiaowei.modules.security.service.JwtUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                 ...
                 * 之后这里要拒绝
                 * */
                .antMatchers("/pes/**").permitAll()

                .antMatchers("/imgcontent/**").permitAll()
                .antMatchers("/imgthum/**").permitAll()
                .antMatchers("/endpointMark/**").permitAll()
                .antMatchers("/massRequest/**").permitAll()
                .antMatchers("/mass/**").permitAll()
